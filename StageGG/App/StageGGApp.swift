...
var stages: [Stage] = [
    Stage(name: "Final Destination", stageInfo: StageInfo(sizeClass: .Medium, category: .Starters), imageName: "fd_stage_name" ),
    Stage(name: "Battlefield", stageInfo: StageInfo(sizeClass: .Medium, category: .Starters), imageName: "fd_stage_name" )
]
